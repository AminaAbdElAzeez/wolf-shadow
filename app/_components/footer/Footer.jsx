        ...
        <div className={styles.footerContent}>
          ...
          <h4 className={styles.footerItemTitle}>quick contact</h4>
            <ul className={styles.footerLocation}>
              <li>
              <Image src={"/images/location.png"} alt="image" width={24} height={25}/>
              <p>Saudi Arabia, <br/> Dammam, Jeddah</p>
              </li>
              <li>
              <Image src={"/images/call.png"} alt="image" width={24} height={25}/>
              <p>+603 4784 273 12</p>
              </li>
              <li>
              <Image src={"/images/sms.png"} alt="image" width={24} height={25}/>
